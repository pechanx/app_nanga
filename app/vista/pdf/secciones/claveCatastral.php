    ...
    <div class="panel-body">
        ...
        <div class="col-md-1">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="clvCanton" name="clvCanton" value="<?= NUM_CANTON ?>" readonly="">
            </div>
        </div>
        <div class="col-md-1">
            <div class="form-group">
                ...
                <select class="form-control selectpicker" id="clvParroquia" name="clvParroquia" required>
                    <?php
                    foreach ($datosParroquias as $parroquias) {
                        ?>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="codigoPredio" name="codigoPredio" maxlength="4" placeholder="0000" required onkeypress="return soloNumeros(event);">
            </div>
        </div>
